        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-12 border border-slate-100 shadow-sm text-center">
                <div className="w-24 h-24 mx-auto bg-orange-50 rounded-3xl flex items-center justify-center mb-6 shadow-inner shadow-orange-100 border border-orange-100">
                    <FileText className="text-orange-500" size={48} strokeWidth={1.5} />
                </div>
                ...
                <p className="text-slate-500 max-w-md mx-auto text-lg leading-relaxed">
                    The <strong>Data Reports</strong> module is currently being built and will be available in the upcoming release.
                </p>
